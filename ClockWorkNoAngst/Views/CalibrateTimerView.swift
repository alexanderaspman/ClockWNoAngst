...
struct CalibrateTimer: View {
   ...
   /* func createAccount(){
        Auth.auth().createAccount(withEmail:email,password:password){
            result,error in
            error == nil else{
...
struct CalibrateTimer_Previews: PreviewProvider {
    static var previews: some View {
        CalibrateTimer( focusOnCircle: true)
    }
}
